...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { artist_id: @painting.artist_id, finished_on: @painting.finished_on, height: @painting.height, price: @painting.price, technique: @painting.technique, title: @painting.title, width: @painting.width }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { artist_id: @painting.artist_id, finished_on: @painting.finished_on, height: @painting.height, price: @painting.price, technique: @painting.technique, title: @painting.title, width: @painting.width }
    assert_redirected_to painting_path(assigns(:painting))
  end
